    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="w-fill text-right py-4">
                <a href="{{ route('backend.lab-information') }}"
        ...
        <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
            <div class="flex flex-col gap-9">
                <form action="{{ route('backend.lab-information.edit', ['id' => $data->lab_information_uuid]) }}"
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-5.5 p-6.5">
                            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                <div class="w-full xl:w-1/2">
                                    <label class="mb-2.5 block text-black dark:text-white">
                                        Lab Name <span class="text-meta-1">*</span>
                                    </label>
                                    <input type="text" name="lab_name" placeholder="Enter lab name"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                        value="{{ $data->lab_information_name }}">
                                    @error('lab_name')
                                ...
                                <div class="w-full xl:w-1/2">
                                    <label class="mb-2.5 block text-black dark:text-white">
                                        Room Number <span class="text-meta-1">*</span>
                                    </label>
                                    <input type="text" name="room_no" placeholder="Enter room no."
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                        value="{{ $data->lab_information_room_no }}">
                                    @error('room_no')
                                        <div class="text-red" role="alert">
                                            {{ $message }}
                                        </div>
                            ...
                            <div>
                                <img width="80" height="80" src="{{ $data->lab_information_photo }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
