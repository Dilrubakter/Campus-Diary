    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <!-- ====== Form Elements Section Start -->
            <div class="w-fill text-right py-4">
                <a href="{{ route('backend.ta-information') }}" class="inline-flex items-center justify-center gap-2.5 rounded-md bg-primary py-3 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8">
                Back
            </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
          <div class="flex flex-col gap-9">
            <form action="{{ route('backend.ta-information.edit', ['id' => $data->uuid]) }}" method ="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="flex flex-col gap-5.5 p-6.5">
                        <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                            <div class="w-full xl:w-1/2">
                              ...
                              <input type="text" name="first_name" placeholder="Enter your first name" value="{{ $data->first_name }}" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                              @error('first_name')
                            ...
                            <div class="w-full xl:w-1/2">
                              ...
                              <input type="text" name="last_name" placeholder="Enter your last name" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" value="{{ $data->last_name }}">
                              @error('last_name')
                              <div class="text-red" role="alert">
                              {{ $message }}
                              </div>
                          ...
                          <div class="mb-4.5">
                            ...
                            <input type="email" name="email" placeholder="Enter your email address" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" value="{{ $data->email }}">
                            @error('email')
                            <div class="text-red" role="alert">
                            {{ $message }}
                            </div>
                          ...
                          <div class="mb-4.5">
                            ...
                            <input type="text" name="phone" placeholder="Enter your phone number" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"  value="{{ $data->phone_no }}">
                            @error('phone')
                            <div class="text-red" role="alert">
                            {{ $message }}
                            </div>
                          ...
                          <div>
                            ...
                            <div class="relative z-20 bg-white dark:bg-form-input">
                              <select class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-12 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input" name="designation">
                      ...
                      <div>
                        <div>
                            ...
                            <div class="relative">
                              <input type="date" name="dob" class="custom-input-date custom-input-date-2 w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"   value="{{ $data->dob }}">
                            </div>
                          </div>
                        @error('dob')
                        <div class="text-red" role="alert">
