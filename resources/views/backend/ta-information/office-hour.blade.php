    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
          <div class="flex flex-col gap-9">
            <form action="{{ route('backend.ta-information.office-hour', ['id' => $data->uuid]) }}" method ="POST" enctype="multipart/form-data">
                @csrf
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    <div class="flex flex-col gap-5.5 p-6.5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                              <input type="time" name="start_time" class="custom-input-date custom-input-date-1 w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                            </div>
                            @error('start_time')
                            <div class="text-red" role="alert">
                            {{ $message }}
                          ...
                          <div>
                            ...
                            <div class="relative">
                              <input type="time" name="end_time" class="custom-input-date custom-input-date-2 w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                            </div>
                            @error('start_time')
                            <div class="text-red" role="alert">
                                {{ $message }}
                        ...
                        <div class="mb-4.5">
                            ...
                            <input type="text" name="course_code" placeholder="Enter your course code" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                            @error('course_code')
                            <div class="text-red" role="alert">
                            {{ $message }}
                            </div>
                        ...
                        <div class="mb-4.5">
                            ...
                            <input type="text" name="room_no" placeholder="Enter your room no" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                            @error('room_no')
                            <div class="text-red" role="alert">
                            {{ $message }}
                            </div>
                        ...
                        <div x-data="{ checkboxOne: false, checkboxTwo: false }">
                            <label for="checkboxLabelFive" class="flex cursor-pointer select-none items-center">
                                <div class="relative">
                                    <input type="checkbox" id="checkboxLabelFive" name="office_hour" class="sr-only" x-model="checkboxOne" @click="checkboxTwo = !checkboxOne">
                                    <div :class="{ 'border-4': checkboxOne }" class="box mr-4 flex h-5 w-5 items-center justify-center rounded-full border border-primary">
                                        <span class="h-2.5 w-2.5 rounded-full bg-white dark:bg-transparent" x-show="checkboxOne"></span>
                                    </div>
                                </div>
                                Office Hour
                            </label>
