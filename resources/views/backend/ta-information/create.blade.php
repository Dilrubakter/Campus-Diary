    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
          <div class="flex flex-col gap-9">
            <form action="{{ route('backend.ta-information') }}" method="POST"  enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="flex flex-col gap-5.5 p-6.5">
                        <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                          ...
                          <div class="mb-4.5">
                            ...
                            <input type="email" name="email" placeholder="Enter your email address" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                            @error('email')
                            <div class="text-red" role="alert">
                            {{ $message }}
                            </div>
                          ...
                          <div class="mb-4.5">
                            ...
                            <input type="text" name="phone" placeholder="Enter your phone number" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                            @error('phone')
                            <div class="text-red" role="alert">
                            {{ $message }}
                            </div>
                      ...
                      <div>
                        <div>
                            ...
                            <div class="relative">
                              <input type="date" name="dob" class="custom-input-date custom-input-date-2 w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                            </div>
                          </div>
                        @error('dob')
                        <div class="text-red" role="alert">
