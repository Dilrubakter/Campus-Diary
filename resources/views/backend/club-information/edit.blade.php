    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <ol class="flex flex-wrap items-center gap-3">
                        ...
                        <li>
                            <a class="flex items-center gap-3 font-medium" href="#">
                                ...
                                <span class="hover:text-primary">Club Information</span>
                            </a>
                        </li>
            ...
            <div class="w-fill text-right py-4">
                <a href="{{ route('backend.club-information') }}"
        ...
        <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
            <div class="flex flex-col gap-9">
                <form action="{{ route('backend.club-information.update', ['id' => $data->club_information_uuid]) }}"
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-5.5 p-6.5">
                            ...
                            <div class="flex flex-col gap-6 xl:flex-row">
                                <div class="w-full">
                                    <label class="mb-2.5 block text-black dark:text-white">
                                        Club Short Name <span class="text-meta-1">*</span>
                                    </label>
                                    <input type="text" name="club_short_name" placeholder="Enter club name"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                        value="{{ $data->club_information_short_name }}">
                                        @error('club_name')
                                        <div class="text-red" role="alert">
                                            {{ $message }}
                                        </div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <div class="relative">
                                            <textarea name="overview" rows="6" placeholder="Enter club bio"
                                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                                value="">{{ $data->club_information_overview }}</textarea>
                                        </div>
                                    </div>
                                    @error('overview')
                                        <div class="text-red" role="alert">
                                ...
                                <div>
                                    <img width="80" height="80" src="{{ $data->club_information_photo }}"
                                        alt="">
                                </div>
                            </div>
                        </div>
