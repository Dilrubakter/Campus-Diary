    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="w-fill text-right py-4">
                <a href="{{ route('backend.club-information.create') }}"
                        ...
                        @foreach ($data as $data)
                            <tr>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">{{ $data['club_information_name'] }}
                                    </p>
                                </td>
                                <td>
                                    <p class="text-black dark:text-white">{{ $data['club_information_short_name'] }}</p>
                                </td>
                                <td>
                                    <p class="text-black dark:text-white">{{ $data['club_information_overview'] }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    @if ($data->club_information_photo)
                                        <img src="{{ asset($data->club_information_photo) }}" width= '50'
                                ...
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <button class="hover:text-primary">
                                            <a
                                                href="{{ route('backend.club-information.view', ['id' => $data->club_information_uuid]) }}">
                                        ...
                                        <form method="POST"
                                            action="{{ route('backend.club-information.destroy', $data->club_information_uuid) }}">
                                        ...
                                        <button class="hover:text-primary">
                                            <a
                                                href="{{ route('backend.club-information.edit', ['id' => $data->club_information_uuid]) }}">
