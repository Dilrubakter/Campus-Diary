    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="w-fill text-right py-4">
                <a href="{{ route('backend.faculty-information.view', ['id' => $data->faculty_informations_uuid]) }}"
        ...
        <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
            <div class="flex flex-col gap-9">
                <form
                    action="{{ route('backend.faculty-information.office-hour', ['id' => $data->faculty_informations_uuid]) }}"
                        ...
                        <div class="flex flex-col gap-5.5 p-6.5">
                            ...
                            <div x-data="{ checkboxOne: false, checkboxTwo: false }">
                                <label for="checkboxLabelFive" class="flex cursor-pointer select-none items-center">
                                    <div class="relative">
                                        <input type="checkbox" id="checkboxLabelFive" name="office_hour"
                                            class="sr-only" x-model="checkboxOne"
                                            @click="checkboxTwo = !checkboxOne">
