    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="w-fill text-right py-4">
                <a href="{{ route('backend.faculty-information') }}"
        ...
        <div class="grid grid-cols-1 gap-9 sm:grid-cols-1">
            <div class="flex flex-col gap-9">
                <form
                    action="{{ route('backend.faculty-information.update', ['id' => $data->faculty_informations_uuid]) }}"
                        ...
                        <div class="flex flex-col gap-5.5 p-6.5">
                            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                <div class="w-full xl:w-1/2">
                                    ...
                                    <input type="text" name="first_name" placeholder="Enter your first name"
                                        ...
                                        value="{{ $data->faculty_informations_first_name }}">
                                    @error('first_name')
                                ...
                                <div class="w-full xl:w-1/2">
                                    ...
                                    <input type="text" name="last_name" placeholder="Enter your last name"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                        value="{{ $data->faculty_informations_last_name }}">
                                    @error('last_name')
                                        <div class="text-red" role="alert">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-4.5">
                                ...
                                <input type="email" name="email" placeholder="Enter your email address"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                    value="{{ $data->faculty_informations_email }}">
                                @error('email')
                                    <div class="text-red" role="alert">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-4.5">
                                <label class="mb-2.5 block text-black dark:text-white">
                                    Room No. <span class="text-meta-1">*</span>
                                </label>
                                <input type="text" name="room_no" placeholder="Enter your room no."
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                    value="{{ $data->faculty_informations_room }}">
                                @error('room_no')
                                    <div class="text-red" role="alert">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-4.5">
                                <label class="mb-2.5 block text-black dark:text-white">
                                    Faculty Type <span class="text-meta-1">*</span>
                                </label>
                            ...
                            <div class="mb-4.5">
                                ...
                                <input type="text" name="phone" placeholder="Enter your phone number"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                    value="{{ $data->faculty_informations_contact }}">
                                @error('phone')
                                    <div class="text-red" role="alert">
                                        {{ $message }}
                                    </div>
                            ...
                            <div>
                                <div>
                                    ...
                                    <div class="relative">
                                        <textarea name="bio" rows="6" placeholder="Enter faculty bio"
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                            value="{{ $data->faculty_informations_bio }}"></textarea>
                                    </div>
                                </div>
                                @error('bio')
                                    <div class="text-red" role="alert">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="date" name="dob"
                                            ...
                                            value="{{ $data->faculty_informations_dob }}">
                                    </div>
                                </div>
                                @error('dob')
                                    <div class="text-red" role="alert">
                            ...
                            <div>
                                <img width="80" height="80" src="{{ $data->faculty_informations_photo }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
