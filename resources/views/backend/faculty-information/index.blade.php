    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <ol class="flex flex-wrap items-center gap-3">
                        ...
                        <li>
                            <a class="flex items-center gap-3 font-medium" href="#">
                                ...
                                <span class="hover:text-primary">Faculty Information</span>
                            </a>
                        </li>
            ...
            <div class="w-fill text-right py-4">
                <a href="{{ route('backend.faculty-information.create') }}"
                        ...
                        @foreach ($data as $data)
                            <tr>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">{{ $data['faculty_informations_first_name'] }}
                                    </p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">{{ $data['faculty_informations_last_name'] }}
                                    </p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">
                                        {{ $data['faculty_informations_designations'] }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">
                                        {{ $data['faculty_informations_faculty_type'] }}
                                    </p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">
                                        {{ $data['faculty_informations_email'] }}
                                    </p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">
                                        {{ $data['faculty_informations_contact'] }}
                                    </p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">{{ $data['faculty_informations_gender'] }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">{{ $data['faculty_informations_dob'] }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">{{ $data['faculty_informations_room'] }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <p class="text-black dark:text-white">{{ $data['faculty_informations_bio'] }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    @if ($data->faculty_informations_photo)
                                        <img src="{{ asset($data->faculty_informations_photo) }}" width= '50'
                                ...
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <button class="hover:text-primary">
                                            <a
                                                href="{{ route('backend.faculty-information.view', ['id' => $data->faculty_informations_uuid]) }}">
                                        ...
                                        <form method="POST"
                                            action="{{ route('backend.ta-information.destroy', $data->faculty_informations_uuid) }}">
                                        ...
                                        <button class="hover:text-primary">
                                            <a
                                                href="{{ route('backend.faculty-information.edit', ['id' => $data->faculty_informations_uuid]) }}">
