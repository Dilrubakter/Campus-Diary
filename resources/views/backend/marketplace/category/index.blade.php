    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <ol class="flex flex-wrap items-center gap-3">
                        ...
                        <li>
                            <a class="flex items-center gap-3 font-medium" href="#">
                                ...
                                <span class="hover:text-primary">Marketplace Category</span>
                            </a>
                        </li>
            ...
            <div class="w-fill text-right py-4">
                <a href="{{ route('backend.marketplace.category.create') }}"
                            ...
                            @foreach ($data as $data)
                                <tr>
                                    <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                        <p class="text-black dark:text-white">{{ $data['marketplace_category_name'] }}
                                        </p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <div class="flex items-center space-x-3.5">
                                            <form method="POST"
                                                action="{{ route('backend.marketplace.category.destroy', $data->marketplace_category_uuid) }}">
                                                @csrf
                                            ...
                                            <button class="hover:text-primary">
                                                <a
                                                    href="{{ route('backend.marketplace.category.edit', ['id' => $data->marketplace_category_uuid]) }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" viewBox="0 0 16 16" id="edit">
                                                        <path fill="#212121"
                        ...
                        @else
                            <tr>
                                <td colspan="4"
                                    ...
                                    <p class="text-black dark:text-white">No Data Found</p>
                                </td>
                            </tr>
                        @endif
                    </tbody>
