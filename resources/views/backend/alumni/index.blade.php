    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="w-fill text-right py-4">
                <a href="{{ route('backend.alumni-information.create') }}"
                    ...
                    <tbody>
                        @foreach ($data as $data)
                            <tr>
                                ...
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <a href="{{ $data['linkedin_profile_link'] }}" class="text-black dark:text-white"
                                        target="__blank">Click Here</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    @if ($data->photo)
                                        <img src="{{ asset($data->photo) }}" width= '50' height='50'
                                ...
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        {{-- <button class="hover:text-primary">
                                            <a
                                                href="{{ route('backend.alumni-information.view', ['id' => $data->uuid]) }}">
                                        ...
                                        <form method="POST"
                                            action="{{ route('backend.alumni-information.destroy', $data->uuid) }}">
                                        ...
                                        <button class="hover:text-primary">
                                            <a
                                                href="{{ route('backend.alumni-information.edit', ['id' => $data->uuid]) }}">
