                    ...
                    <ul> <!-- SLIDE  -->
                        <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default"
                            ...
                            <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-100-layer-3"
                                ...
                                Discover, Connect, and Engage: Your Ultimate Campus Diary
                            </div>
                            ...
                            <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-100-layer-4"
                                ...
                                Explore academic resources, connect with peers, and navigate campus life seamlessly with our
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center heading-bx">
                            <h2 class="title-head m-b0">Posts</span></h2>
                            <p class="m-b0">Engage with peers, join forums, and participate in discussions. </p>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-white heading-bx left">
                            <h2 class="title-head text-uppercase">Alumni </h2>
                            ...
                            <div class="item">
                                <div class="testimonial-bx">
                                    <div class="testimonial-thumb">
                                        <img src="{{ $data['photo'] ? $data['photo'] : asset('assets/images/dummy.png') }}"
                                            alt="">
                                    </div>
                                    <div class="testimonial-info">
                                        <h5 class="name">{{ $data['first_name'] }} {{ $data->last_name }}</h5>
                                        <p>-{{ $data['designations'] }}</p>
                                    </div>
