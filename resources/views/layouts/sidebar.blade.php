        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'AdminSettings') && (page === 'AdminSettings') }"
            ...
            >
              ...
              <svg
                class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                :class="{ 'rotate-180': (selected === 'AdminSettings') }"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              class="overflow-hidden"
              :class="(selected === 'AdminSettings') ? 'block' :'hidden'"
            >
              <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
