                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            ...
                            @click.prevent="selected = (selected === 'Lab Information' ? '':'Lab Information')"
                            :class="{
                                'bg-graydark dark:bg-meta-4': (selected === 'Lab Information') || (
                                    page === 'Lab List' ||
                                    page === 'analytics')
                            }">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden" :class="(selected === 'Lab Information') ? 'block' : 'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.lab-information') }}"
                                        :class="page === 'Lab List' && '!text-white'">Lab List</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.lab-information.create') }}"
                                        :class="page === 'Lab Information' && '!text-white'">Add Lab</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="javascript:void(0)"
                            @click.prevent="selected = (selected === 'TA Information' ? '':'TA Information')"
                            :class="{
                                'bg-graydark dark:bg-meta-4': (selected === 'TA Information') || (
                                    page === 'TA List' ||
                                    page === 'Add TA')
                            }">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden" :class="(selected === 'TA Information') ? 'block' : 'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.ta-information') }}"
                                        :class="page === 'TA List' && '!text-white'">TA List</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.ta-information.create') }}"
                                        :class="page === 'Add TA' && '!text-white'">Add TA</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="javascript:void(0)"
                            @click.prevent="selected = (selected === 'Faculty Information' ? '':'Faculty Information')"
                            :class="{
                                'bg-graydark dark:bg-meta-4': (selected === 'Faculty Information') || (
                                    page === 'Faculty List' ||
                                    page === 'Add Faculty')
                            }">
                        ...
                        <div class="overflow-hidden"
                            :class="(selected === 'Faculty Information') ? 'block' : 'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.faculty-information') }}"
                                        :class="page === 'Faculty List' && '!text-white'">Faculty List</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.faculty-information.create') }}"
                                        :class="page === 'Add Faculty' && '!text-white'">Add Faculty</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="javascript:void(0)"
                            @click.prevent="selected = (selected === 'Alumni Information' ? '':'Alumni Information')"
                            :class="{
                                'bg-graydark dark:bg-meta-4': (selected === 'Alumni Information') || (
                                    page === 'Alumni List' ||
                                    page === 'Add Alumni')
                            }">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden"
                            :class="(selected === 'Alumni Information') ? 'block' : 'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.alumni-information') }}"
                                        :class="page === 'Alumni List' && '!text-white'">Alumni List</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.alumni-information.create') }}"
                                        :class="page === 'Add Alumni' && '!text-white'">Add Alumni</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="javascript:void(0)"
                            @click.prevent="selected = (selected === 'Club Information' ? '':'Club Information')"
                            :class="{
                                'bg-graydark dark:bg-meta-4': (selected === 'Club Information') || (
                                    page === 'Club List' ||
                                    page === 'Add Club')
                            }">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden" :class="(selected === 'Club Information') ? 'block' : 'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.club-information') }}"
                                        :class="page === 'Club List' && '!text-white'">Club List</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.club-information.create') }}"
                                        :class="page === 'Add Club' && '!text-white'">Add Club</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="settings.html"
                            @click.prevent="selected = (selected === 'AdminSettings' ? '':'AdminSettings')"
                            :class="{
                                'bg-graydark dark:bg-meta-4': (selected === 'AdminSettings') && (
                                    page === 'AdminSettings')
                            }"
                            :class="page === 'AdminSettings' && 'bg-graydark'">
                            <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            Admin Settings
                            <svg class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                                :class="{ 'rotate-180': (selected === 'AdminSettings') }" width="20"
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden" :class="(selected === 'AdminSettings') ? 'block' : 'hidden'">
                            <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.timeschedule') }}"
                                        :class="page === 'formElements' && '!text-white'">Time Slot</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('backend.day') }}"
                                        :class="page === 'formElements' && '!text-white'">Day</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
